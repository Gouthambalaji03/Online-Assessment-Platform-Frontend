  ...
  return (
    <Layout>
      <div className="animate-fade-in">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-text-primary mb-2">Available Exams</h1>
          <p className="text-sm text-text-muted">Browse and enroll in upcoming assessments</p>
        </div>

        {exams.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {exams.map((exam) => (
              <div key={exam._id} className="card hover:border-border-hover hover:shadow-lg">
                <div className="flex items-start justify-between mb-4">
                  ...
                  {exam.isProctored && (
                    <span className="badge-warning">Proctored</span>
                  )}
                </div>
          ...
          <div className="card text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-text-primary mb-2">No Exams Available</h3>
            <p className="text-sm text-text-muted mb-5">Check back later for upcoming assessments</p>
            <Link to="/my-exams" className="btn-secondary inline-flex no-underline">
              View My Exams
            </Link>
          </div>
        )}
