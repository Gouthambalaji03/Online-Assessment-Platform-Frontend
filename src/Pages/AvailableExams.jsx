    ...
    <Layout>
      <div className="animate-fadeIn">
        <div className="mb-8">
          ...
          <p className="text-gray-400">Browse and enroll in upcoming assessments</p>
        </div>
        ...
        {exams.length > 0 ? (
            ...
            {exams.map((exam) => (
              <div key={exam._id} className="glass-card p-6 hover:border-orange-500/30 transition-all">
                <div className="flex items-start justify-between mb-4">
                  <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-orange-500/20 to-orange-600/10 flex items-center justify-center">
          ...
          <div className="glass-card p-12 text-center">
            ...
            <p className="text-gray-400">Check back later for upcoming assessments</p>
          </div>
        )}
      </div>
    </Layout>
